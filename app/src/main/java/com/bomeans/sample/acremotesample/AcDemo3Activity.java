...
/**
 * This demo shows how to use seek bar to set the temperature directly, instead of using
 * temperature+/- to step up/down the temperature.
 */
public class AcDemo3Activity extends AppCompatActivity {
    ...
    private void createMyGUI() {
        ...
        if (containString("IR_ACKEY_TEMP", allSupportedKeys)) {
            ...
            BIRKeyOption tempKeyOptions = mMyAcRemote.getKeyOption("IR_ACKEY_TEMP");
    ...
    // temperature key GUI
    private void updateTempGUI(BIRKeyOption tempKeyOptions) {
